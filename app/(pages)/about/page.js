...
export default function About() {
    ...
    const renderCategoryType = () => {
        return Object.keys(categories).map((category) => (
            <Tab
                ...
                className={({ selected }) =>
                    classNames(
                        'w-full rounded-lg py-2.5 text-sm md:text-xl font-medium leading-5 text-orange-400',
    ...
    const renderCategory = () => {
        return Object.values(categories).map((posts, idx) => (
            <Tab.Panel
                key={idx}
                        ...
                        >
                            <div className="flex justify-start items-start gap-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <ul className="mt-1 flex text-xs md:text-lg font-normal leading-4 text-gray-500">
                                        <li>{post.date}</li>
    ...
    return (
        <main className="container mx-auto">
            <div className="flex flex-col-reverse lg:flex-row min-h-[92vh] p-5 md:p-24">
                    ...
                    <div className="leading-8 mt-8">
                        ...
                        >
                            <p className="text-[#121212]">
                                ...
                                ini. Aku juga suka mengeksplorasi hal-hal yang baru khususnya di
                            ...
                            <br />
                            <h2 className="text-xl md:text-3xl mb-2 font-semibold">Hobi yang aku gemari</h2>
                            <ol className="list-decimal list-inside space-y-5 marker:text-dimWhite md:p-2">
                                <li>
                                    <span className="font-medium">Pengembangan Game</span>
                                    <p className="text-[#121212]">Selain aku memiliki kemampuan dalam pembuatan aplikasi sebagai kompetensi dasar dan untuk bekerja, aku memiliki hobi yang masih berkaitan dengan programming tetapi tidak berkaitan dengan pekerjaan, yaitu dalam membuat sebuah game yang menurutku seru untuk dibuat.</p>
                                </li>
                                <li>
                                    <span className="font-medium">Mendengarkan Musik</span>
                                    <p className="text-[#121212]">Aku lebih suka phonk, karena beatnya itu dapat membakar semangatku ketika sedang membuat kode program.</p>
                                </li>
                                <li>
                                    <span className="font-medium">Menonton Film</span>
                                    <p className="text-[#121212]">Film bagiku itu adalah sebuah pintu agar aku dapat keluar dari burnout setelah sekian lama menatap komputer untuk melakukan debugging kode, revisi klien, dan segala urusan yang berbau mengenai tugas dan pekerjaan.</p>
                                </li>
                            </ol>
                            <br />
                            <h2 className="text-xl md:text-3xl mb-2 font-semibold">Skill yang aku miliki</h2>
                            <Tab.Group>
